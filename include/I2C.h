...
#define I2C_REG_ICR_ADDRCF		((uint32_t) 1 << 3)
#define I2C_REG_ICR_NACKF		((uint32_t) 1 << 4)
#define I2C_REG_ICR_STOPCF		((uint32_t) 1 << 5)
#define I2C_REG_ICR_BERRF		((uint32_t) 1 << 8)
#define I2C_REG_ICR_ARLOCF		((uint32_t) 1 << 9)
#define I2C_REG_ICR_OVROCF		((uint32_t) 1 << 10)
#define I2C_REG_ICR_PECCF		((uint32_t) 1 << 11)
#define I2C_REG_ICR_TIMEOUTCF	((uint32_t) 1 << 12)
#define I2C_REG_ICR_ALERTCF		((uint32_t) 1 << 13)
