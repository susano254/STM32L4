...
namespace AML {
	...
	Matrix33::Matrix33(double value)
	...
	//Matrix Scalar
  	Matrix33 operator+(const Matrix33 &lhs, double rhs){ return (Matrix33(lhs) += rhs); }
  	Matrix33 operator-(const Matrix33 &lhs, double rhs){ return (Matrix33(lhs) -= rhs); }
  	Matrix33 operator*(const Matrix33 &lhs, double rhs){ return (Matrix33(lhs) *= rhs); }
  	Matrix33 operator/(const Matrix33 &lhs, double rhs){ return (Matrix33(lhs) /= rhs); }
 	Matrix33 operator+(double lhs, const Matrix33 &rhs){ return (Matrix33(lhs) += rhs); }
	Matrix33 operator-(double lhs, const Matrix33 &rhs){ return (Matrix33(lhs) -= rhs); }
	Matrix33 operator*(double lhs, const Matrix33 &rhs){ return (Matrix33(rhs) *= lhs); }
